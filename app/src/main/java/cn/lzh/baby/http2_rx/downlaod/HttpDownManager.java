...
import cn.lzh.baby.http2_rx.downlaod.DownLoadListener.DownloadInterceptor;
import cn.lzh.baby.http2_rx.exception.HttpTimeException;
import cn.lzh.baby.http2_rx.exception.RetryWhenNetworkException;
import cn.lzh.baby.http2_rx.subscribers.ProgressDownSubscriber;
...
public class HttpDownManager {
    ...
    /*数据库类*/
    private DownInfoDbUtil db;

    private HttpDownManager(){
        downInfos=new HashSet<>();
        subMap=new HashMap<>();
        db= new DownInfoDbUtil();
    }
