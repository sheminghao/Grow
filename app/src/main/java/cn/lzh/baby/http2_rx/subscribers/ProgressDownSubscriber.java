...
import cn.lzh.baby.http2_rx.Db.DownInfoDbUtil;
import cn.lzh.baby.http2_rx.downlaod.DownInfo;
import cn.lzh.baby.http2_rx.downlaod.DownLoadListener.DownloadProgressListener;
import cn.lzh.baby.http2_rx.downlaod.DownState;
import cn.lzh.baby.http2_rx.downlaod.HttpDownManager;
...
public class ProgressDownSubscriber<T> extends Subscriber<T> implements DownloadProgressListener {
    ...
    private DownInfoDbUtil db=new DownInfoDbUtil();
